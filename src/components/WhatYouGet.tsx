...
export const WhatYouGet = () => {
  ...
  return (
    <section id="o-que-voce-recebe" className="py-20 px-4 bg-gradient-to-r from-blue-50 to-indigo-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {features.map((feature, index) => (
            <ScrollAnimation 
              ...
              delay={index * 150}
            >
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-blue-200">
        ...
        <ScrollAnimation animation="scale-up" delay={600}>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-200 text-center">
            <h3 className="text-2xl font-bold text-blue-800 mb-4">🌟 Testado e aprovado</h3>
            <p className="text-lg text-blue-700">Por centenas de mães e crianças exigentes</p>
          </div>
        </ScrollAnimation>
      </div>
    </section>
